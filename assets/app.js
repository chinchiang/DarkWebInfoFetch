...
const I18N = {
  zh: {
    ...
    tagline: "彙整 9 個精選 X(Twitter)資安情資帳號:暗網資料外洩、勒索軟體、地下市場與惡意軟體動態,每日約 05:00 與 13:00(UTC+8)自動抓取更新。",
  ...
  en: {
    ...
    tagline: "Aggregates 9 curated X (Twitter) accounts: dark web data leaks, ransomware, underground markets and malware activity — automatically fetched twice daily around 05:00 & 13:00 (UTC+8).",
